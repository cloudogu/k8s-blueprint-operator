...
require (
	...
	github.com/cloudogu/k8s-component-operator v1.1.0
...
require (
	...
	github.com/cloudogu/k8s-host-change v0.3.2 // indirect
	github.com/cloudogu/k8s-registry-lib v0.1.0 // indirect
