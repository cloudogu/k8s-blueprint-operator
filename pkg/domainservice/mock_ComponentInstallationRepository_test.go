// Code generated by mockery bpv2.42.1. DO NOT EDIT.
...
func (_m *MockComponentInstallationRepository) Delete(ctx context.Context, componentName bpv2.SimpleComponentName) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, bpv2.SimpleComponentName) error); ok {
...
func (_c *MockComponentInstallationRepository_Delete_Call) Run(run func(ctx context.Context, componentName bpv2.SimpleComponentName)) *MockComponentInstallationRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bpv2.SimpleComponentName))
	})
	return _c
}
...
func (_c *MockComponentInstallationRepository_Delete_Call) RunAndReturn(run func(context.Context, bpv2.SimpleComponentName) error) *MockComponentInstallationRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// GetAll provides a mock function with given fields: ctx
func (_m *MockComponentInstallationRepository) GetAll(ctx context.Context) (map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation, error) {
	ret := _m.Called(ctx)
	...
	var r0 map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation)
		}
	}
...
func (_c *MockComponentInstallationRepository_GetAll_Call) Return(_a0 map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation, _a1 error) *MockComponentInstallationRepository_GetAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockComponentInstallationRepository_GetAll_Call) RunAndReturn(run func(context.Context) (map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation, error)) *MockComponentInstallationRepository_GetAll_Call {
	_c.Call.Return(run)
	return _c
}

// GetByName provides a mock function with given fields: ctx, componentName
func (_m *MockComponentInstallationRepository) GetByName(ctx context.Context, componentName bpv2.SimpleComponentName) (*ecosystem.ComponentInstallation, error) {
	ret := _m.Called(ctx, componentName)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bpv2.SimpleComponentName) (*ecosystem.ComponentInstallation, error)); ok {
		return rf(ctx, componentName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, bpv2.SimpleComponentName) *ecosystem.ComponentInstallation); ok {
		r0 = rf(ctx, componentName)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, bpv2.SimpleComponentName) error); ok {
...
func (_c *MockComponentInstallationRepository_GetByName_Call) Run(run func(ctx context.Context, componentName bpv2.SimpleComponentName)) *MockComponentInstallationRepository_GetByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bpv2.SimpleComponentName))
	})
	return _c
...
func (_c *MockComponentInstallationRepository_GetByName_Call) RunAndReturn(run func(context.Context, bpv2.SimpleComponentName) (*ecosystem.ComponentInstallation, error)) *MockComponentInstallationRepository_GetByName_Call {
	_c.Call.Return(run)
	return _c
}
