...
type mockConstructorTestingTnewMockHealthConfigProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockHealthConfigProvider(t mockConstructorTestingTnewMockHealthConfigProvider) *mockHealthConfigProvider {
