...
type mockConstructorTestingTnewMockEffectiveBlueprintUseCase interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockEffectiveBlueprintUseCase(t mockConstructorTestingTnewMockEffectiveBlueprintUseCase) *mockEffectiveBlueprintUseCase {
