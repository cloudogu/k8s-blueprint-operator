...
type mockConstructorTestingTnewMockDoguRestartUseCase interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDoguRestartUseCase(t mockConstructorTestingTnewMockDoguRestartUseCase) *mockDoguRestartUseCase {
