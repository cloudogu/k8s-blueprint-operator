...
type mockConstructorTestingTnewMockRegistryConfigUseCase interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockRegistryConfigUseCase(t mockConstructorTestingTnewMockRegistryConfigUseCase) *mockRegistryConfigUseCase {
