...
type mockConstructorTestingTnewMockSelfUpgradeUseCase interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSelfUpgradeUseCase(t mockConstructorTestingTnewMockSelfUpgradeUseCase) *mockSelfUpgradeUseCase {
