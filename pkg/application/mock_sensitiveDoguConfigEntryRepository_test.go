...
func (_m *mockSensitiveDoguConfigEntryRepository) SaveAllForNotInstalledDogu(_a0 context.Context, _a1 common.SimpleDoguName, _a2 []*ecosystem.SensitiveDoguConfigEntry) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SaveAllForNotInstalledDogu")
	}
...
func (_m *mockSensitiveDoguConfigEntryRepository) SaveAllForNotInstalledDogus(_a0 context.Context, _a1 []*ecosystem.SensitiveDoguConfigEntry) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SaveAllForNotInstalledDogus")
	}
...
func (_m *mockSensitiveDoguConfigEntryRepository) SaveForNotInstalledDogu(ctx context.Context, entry *ecosystem.SensitiveDoguConfigEntry) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SaveForNotInstalledDogu")
	}
