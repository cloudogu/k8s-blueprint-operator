...
func TestSensitiveDoguConfigRepository_Get(t *testing.T) {
	...
	t.Run("internal error if connection error happens", func(t *testing.T) {
		...
		//then
		assert.ErrorContains(t, err, givenError.Error())
		assert.ErrorContains(t, err, fmt.Sprintf("could not load sensitive dogu config for %s", doguCas.String()))
...
func TestSensitiveDoguConfigRepository_Update(t *testing.T) {
	...
	t.Run("conflicts while updating dogu config", func(t *testing.T) {
		...
		//then
		assert.ErrorContains(t, err, givenError.Error())
		assert.ErrorContains(t, err, fmt.Sprintf("could not update sensitive dogu config for %s", doguCas.String()))
...
func TestSensitiveDoguConfigRepository_GetAll(t *testing.T) {
