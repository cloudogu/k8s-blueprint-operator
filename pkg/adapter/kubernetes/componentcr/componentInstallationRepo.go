...
func (repo *componentInstallationRepo) GetByName(ctx context.Context, componentName bpv2.SimpleComponentName) (*ecosystem.ComponentInstallation, error) {
...
func (repo *componentInstallationRepo) GetAll(ctx context.Context) (map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation, error) {
	list, err := repo.componentClient.List(ctx, metav1.ListOptions{})
	if err != nil {
		return nil, err
	}

	componentInstallations := make(map[bpv2.SimpleComponentName]*ecosystem.ComponentInstallation, len(list.Items))
	for _, componentCr := range list.Items {
		...
		componentInstallations[bpv2.SimpleComponentName(componentCr.Name)] = cr
	}
...
func (repo *componentInstallationRepo) Delete(ctx context.Context, componentName bpv2.SimpleComponentName) error {
