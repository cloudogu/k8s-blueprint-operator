		...
		},
		{
			...
			args{spec: domain.BlueprintMask{
				Dogus: []domain.MaskDogu{
					{Name: cescommons.QualifiedDoguName{Namespace: "official", SimpleName: "nginx"}, Version: version1_2_0_1, TargetState: domain.TargetStatePresent},
					{Name: cescommons.QualifiedDoguName{Namespace: "premium", SimpleName: "jira"}, Version: version3_0_2_2, TargetState: domain.TargetStateAbsent},
				},
			}},
...
func TestSerializeBlueprintMask_error(t *testing.T) {
	...
	mask := domain.BlueprintMask{
		Dogus: []domain.MaskDogu{
			{Name: cescommons.QualifiedDoguName{Namespace: "official", SimpleName: "nginx"}, Version: version1_2_0_1, TargetState: -1},
		},
	}
