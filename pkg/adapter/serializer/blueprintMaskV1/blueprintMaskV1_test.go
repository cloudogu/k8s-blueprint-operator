...
func Test_ConvertToBlueprintMaskV1_ok(t *testing.T) {
	dogus := []domain.MaskDogu{
		{Name: cescommons.QualifiedDoguName{Namespace: "absent", SimpleName: "dogu1"}, Version: version3211, TargetState: domain.TargetStateAbsent},
		{Name: cescommons.QualifiedDoguName{Namespace: "absent", SimpleName: "dogu2"}, TargetState: domain.TargetStateAbsent},
		{Name: cescommons.QualifiedDoguName{Namespace: "present", SimpleName: "dogu3"}, Version: version3212, TargetState: domain.TargetStatePresent},
		{Name: cescommons.QualifiedDoguName{Namespace: "present", SimpleName: "dogu4"}, Version: version1_2_3_3},
	}
...
func Test_ConvertToBlueprintMaskV1_error(t *testing.T) {
	dogus := []domain.MaskDogu{
		{Name: cescommons.QualifiedDoguName{Namespace: "absent", SimpleName: "dogu1"}, Version: version3211, TargetState: -1},
	}
	blueprint := domain.BlueprintMask{Dogus: dogus}
