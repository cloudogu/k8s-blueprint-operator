...
// UpdateStatusCompleted provides a mock function with given fields: ctx, blueprint
func (_m *MockBlueprintInterface) UpdateStatusCompleted(ctx context.Context, blueprint *v1.Blueprint) (*v1.Blueprint, error) {
	ret := _m.Called(ctx, blueprint)

	var r0 *v1.Blueprint
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1.Blueprint) (*v1.Blueprint, error)); ok {
		return rf(ctx, blueprint)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *v1.Blueprint) *v1.Blueprint); ok {
		r0 = rf(ctx, blueprint)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1.Blueprint)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *v1.Blueprint) error); ok {
		r1 = rf(ctx, blueprint)
	} else {
		r1 = ret.Error(1)
	}
...
// MockBlueprintInterface_UpdateStatusCompleted_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateStatusCompleted'
type MockBlueprintInterface_UpdateStatusCompleted_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - blueprint *v1.Blueprint
func (_e *MockBlueprintInterface_Expecter) UpdateStatusCompleted(ctx interface{}, blueprint interface{}) *MockBlueprintInterface_UpdateStatusCompleted_Call {
	return &MockBlueprintInterface_UpdateStatusCompleted_Call{Call: _e.mock.On("UpdateStatusCompleted", ctx, blueprint)}
}

func (_c *MockBlueprintInterface_UpdateStatusCompleted_Call) Run(run func(ctx context.Context, blueprint *v1.Blueprint)) *MockBlueprintInterface_UpdateStatusCompleted_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.Blueprint))
	})
	return _c
}

func (_c *MockBlueprintInterface_UpdateStatusCompleted_Call) Return(_a0 *v1.Blueprint, _a1 error) *MockBlueprintInterface_UpdateStatusCompleted_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBlueprintInterface_UpdateStatusCompleted_Call) RunAndReturn(run func(context.Context, *v1.Blueprint) (*v1.Blueprint, error)) *MockBlueprintInterface_UpdateStatusCompleted_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateStatusFailed provides a mock function with given fields: ctx, blueprint
func (_m *MockBlueprintInterface) UpdateStatusFailed(ctx context.Context, blueprint *v1.Blueprint) (*v1.Blueprint, error) {
	ret := _m.Called(ctx, blueprint)
...
// MockBlueprintInterface_UpdateStatusFailed_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateStatusFailed'
type MockBlueprintInterface_UpdateStatusFailed_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - blueprint *v1.Blueprint
func (_e *MockBlueprintInterface_Expecter) UpdateStatusFailed(ctx interface{}, blueprint interface{}) *MockBlueprintInterface_UpdateStatusFailed_Call {
	return &MockBlueprintInterface_UpdateStatusFailed_Call{Call: _e.mock.On("UpdateStatusFailed", ctx, blueprint)}
}

func (_c *MockBlueprintInterface_UpdateStatusFailed_Call) Run(run func(ctx context.Context, blueprint *v1.Blueprint)) *MockBlueprintInterface_UpdateStatusFailed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.Blueprint))
	})
	return _c
...
func (_c *MockBlueprintInterface_UpdateStatusFailed_Call) Return(_a0 *v1.Blueprint, _a1 error) *MockBlueprintInterface_UpdateStatusFailed_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBlueprintInterface_UpdateStatusFailed_Call) RunAndReturn(run func(context.Context, *v1.Blueprint) (*v1.Blueprint, error)) *MockBlueprintInterface_UpdateStatusFailed_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateStatusInProgress provides a mock function with given fields: ctx, blueprint
func (_m *MockBlueprintInterface) UpdateStatusInProgress(ctx context.Context, blueprint *v1.Blueprint) (*v1.Blueprint, error) {
	ret := _m.Called(ctx, blueprint)
...
// MockBlueprintInterface_UpdateStatusInProgress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateStatusInProgress'
type MockBlueprintInterface_UpdateStatusInProgress_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - blueprint *v1.Blueprint
func (_e *MockBlueprintInterface_Expecter) UpdateStatusInProgress(ctx interface{}, blueprint interface{}) *MockBlueprintInterface_UpdateStatusInProgress_Call {
	return &MockBlueprintInterface_UpdateStatusInProgress_Call{Call: _e.mock.On("UpdateStatusInProgress", ctx, blueprint)}
}

func (_c *MockBlueprintInterface_UpdateStatusInProgress_Call) Run(run func(ctx context.Context, blueprint *v1.Blueprint)) *MockBlueprintInterface_UpdateStatusInProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.Blueprint))
	})
	return _c
...
func (_c *MockBlueprintInterface_UpdateStatusInProgress_Call) Return(_a0 *v1.Blueprint, _a1 error) *MockBlueprintInterface_UpdateStatusInProgress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBlueprintInterface_UpdateStatusInProgress_Call) RunAndReturn(run func(context.Context, *v1.Blueprint) (*v1.Blueprint, error)) *MockBlueprintInterface_UpdateStatusInProgress_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateStatusInvalid provides a mock function with given fields: ctx, blueprint
func (_m *MockBlueprintInterface) UpdateStatusInvalid(ctx context.Context, blueprint *v1.Blueprint) (*v1.Blueprint, error) {
	ret := _m.Called(ctx, blueprint)
...
// MockBlueprintInterface_UpdateStatusInvalid_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateStatusInvalid'
type MockBlueprintInterface_UpdateStatusInvalid_Call struct {
	*mock.Call
}

// UpdateStatusInvalid is a helper method to define mock.On call
//   - ctx context.Context
//   - blueprint *v1.Blueprint
func (_e *MockBlueprintInterface_Expecter) UpdateStatusInvalid(ctx interface{}, blueprint interface{}) *MockBlueprintInterface_UpdateStatusInvalid_Call {
	return &MockBlueprintInterface_UpdateStatusInvalid_Call{Call: _e.mock.On("UpdateStatusInvalid", ctx, blueprint)}
}

func (_c *MockBlueprintInterface_UpdateStatusInvalid_Call) Run(run func(ctx context.Context, blueprint *v1.Blueprint)) *MockBlueprintInterface_UpdateStatusInvalid_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.Blueprint))
	})
	return _c
...
func (_c *MockBlueprintInterface_UpdateStatusInvalid_Call) Return(_a0 *v1.Blueprint, _a1 error) *MockBlueprintInterface_UpdateStatusInvalid_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBlueprintInterface_UpdateStatusInvalid_Call) RunAndReturn(run func(context.Context, *v1.Blueprint) (*v1.Blueprint, error)) *MockBlueprintInterface_UpdateStatusInvalid_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateStatusRetrying provides a mock function with given fields: ctx, blueprint
func (_m *MockBlueprintInterface) UpdateStatusRetrying(ctx context.Context, blueprint *v1.Blueprint) (*v1.Blueprint, error) {
	ret := _m.Called(ctx, blueprint)
...
// MockBlueprintInterface_UpdateStatusRetrying_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateStatusRetrying'
type MockBlueprintInterface_UpdateStatusRetrying_Call struct {
	*mock.Call
}

// UpdateStatusRetrying is a helper method to define mock.On call
//   - ctx context.Context
//   - blueprint *v1.Blueprint
func (_e *MockBlueprintInterface_Expecter) UpdateStatusRetrying(ctx interface{}, blueprint interface{}) *MockBlueprintInterface_UpdateStatusRetrying_Call {
	return &MockBlueprintInterface_UpdateStatusRetrying_Call{Call: _e.mock.On("UpdateStatusRetrying", ctx, blueprint)}
}

func (_c *MockBlueprintInterface_UpdateStatusRetrying_Call) Run(run func(ctx context.Context, blueprint *v1.Blueprint)) *MockBlueprintInterface_UpdateStatusRetrying_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.Blueprint))
	})
	return _c
...
func (_c *MockBlueprintInterface_UpdateStatusRetrying_Call) Return(_a0 *v1.Blueprint, _a1 error) *MockBlueprintInterface_UpdateStatusRetrying_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBlueprintInterface_UpdateStatusRetrying_Call) RunAndReturn(run func(context.Context, *v1.Blueprint) (*v1.Blueprint, error)) *MockBlueprintInterface_UpdateStatusRetrying_Call {
	_c.Call.Return(run)
	return _c
}
...
type mockConstructorTestingTNewMockBlueprintInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockBlueprintInterface(t mockConstructorTestingTNewMockBlueprintInterface) *MockBlueprintInterface {
